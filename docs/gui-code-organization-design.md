...
> Status: proposed target architecture (normative for refactors; not yet fully migrated)
...
`packages/gui/docs/ui-guidelines.md`; product behavior stays in feature docs.
