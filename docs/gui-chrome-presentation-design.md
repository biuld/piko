...
> Feature contract: [GUI Chrome Presentation](gui-chrome-presentation-feature.md)
> Visual rules: [UI Guidelines](../packages/gui/docs/ui-guidelines.md)
> Parent design: [GPUI Desktop Client Design](gui-design.md) §12
