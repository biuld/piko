...
> Status: implemented
> Visual rules: [UI Guidelines](../packages/gui/docs/ui-guidelines.md) §IslandPanel / §Trees
> Related: [GUI Chrome Presentation](gui-chrome-presentation-feature.md) (icons / type / copy only)
