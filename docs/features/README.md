...
| F-27 | agent-todo-list | Agent-scoped todo list (goal compression); host projection; TUI dock strip; tools `todo_*` | draft (F-27/D-39) | piko product direction; orchd todo tools baseline |
