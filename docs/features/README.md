...
| F-43 | desktop-agent-workspace | Right column is a tab group of the current session’s agents; workspace toolbar, quiet window status, and redesigned Composer | partial (D-60 PRs 2–5; visual acceptance pending) | piko product direction after F-42 screenshot review |
