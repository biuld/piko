...
| F-48 | authoritative-agent-lifecycle | Run → Execution → ModelStep boundaries, optional source Turn relation, atomic model-step journal facts, reliable thought/tool convergence, and recovery identity | implemented (D-65/ADR-025/V-60); Turn relation refined by F-51/ADR-027 | piko runtime/journal review |
...
| F-51 | agent-work-lifecycle-and-control-plane | Canonical AgentInput/Turn/Run/Execution/ModelStep lifecycle, durable steer/follow-up queue, host work projection, and unified controls | proposed; Slice 1 interrupt implemented (D-68/V-64) | piko product/runtime review; F-01/F-10/F-22/F-31/F-48 |
