...
| F-36 | agent-run-trajectory | Durable best-effort diagnostic capture for prompt assembly, model/provider steps, tool transitions, child observations, retries, and terminal detail; replaces D-30 prompt debugging and OTel span export; required journal facts remain authoritative | implemented (F-36/D-49/V-49); web viewer retired by ADR-029; inspection is F-52 | piko product decision; F-15 gap analysis; F-31 journal |
...
| F-40 | multimodal-user-input | Structured text/image submission and steering; clipboard and local-image-path ingestion; durable queued content | implemented | DeepSeek image-understanding contract; piko product direction |
...
| F-42 | desktop-gui-shell | Two-column desktop window with a floating navigation sidebar, one dominant Timeline, and a bottom-floating Composer | partial (D-59/V-59 automated; visual acceptance pending; agent switcher superseded by F-43) | piko product direction; macOS desktop window conventions |
| F-43 | desktop-agent-workspace | Right column is a tab group of the current session’s agents; workspace toolbar, quiet window status, and redesigned Composer | partial (D-60 PRs 2–5; canvas/picker visuals closed by F-44) | piko product direction after F-42 screenshot review |
...
| F-48 | authoritative-agent-lifecycle | Atomic model-step journal facts, reliable thought/tool convergence, and distinct runtime correlation IDs | implemented (D-65/ADR-025/V-60); core lifecycle hierarchy refined by F-51/ADR-027 | piko runtime/journal review |
...
| F-51 | agent-work-lifecycle-and-control-plane | Session/Agent/ModelStep invariants; AgentInput stimulus and root-work identity; TUI cutover; delete Turn/Run/Execution leftovers | proposed; slices 1–5 and 6.1–6.2 landed; Slice 6.3+ leftovers remain (D-68/V-64) | piko product/runtime review; F-01/F-10/F-22/F-31/F-48 |
| F-52 | session-history-inspector | Read-only TUI history organized from authoritative journal facts by Session/Agent/root AgentInput/ModelStep, with Work/Agents/Transcript/Journal lenses and optional trajectory enrichment | in progress (D-69/ADR-028/ADR-029); four lenses, paging, restart E2E, soak, and web-viewer retirement landed | piko product decision; F-31/F-36/F-37/F-48/F-51 |
