...
| F-15 | observability | End-to-end tracing, usage accounting, durable rollout paging, exact turn diffs, local prompt debugging, and OTel GenAI prompt inspection | implemented for committed scope (D-15/V-15, D-29–D-32/V-29–V-32, D-46/V-46) | core/src/otel_init.rs, rollout*.rs, turn_timing.rs, turn_diff_tracker.rs, prompt_debug.rs |
