...
| F-51 | agent-work-lifecycle-and-control-plane | Agent/Input/ModelStep primitive facts; derived Run/Execution/Turn/queue/foreground views; in-place storage evolution and unified controls | proposed; Slice 1 interrupt implemented (D-68/V-64) | piko product/runtime review; F-01/F-10/F-22/F-31/F-48 |
