...
> Feature contracts:
> [GUI Overlay Stack](gui-overlay-stack-feature.md),
...
|---|---|---|
| `chrome/overlay` | stack, priority, backdrop, panel geometry, Escape, focus trap/restore | host prompt semantics, catalog authority |
...
```text
packages/gui/src/chrome/overlay/
├── mod.rs
