...
impl McpProvider {
    ...
    pub(super) async fn discover_resources(&self) -> (Vec<McpResource>, Vec<McpResourceTemplate>) {
    ...
    pub(super) async fn discover(&self) -> Result<Vec<ToolDef>, String> {
        let response = self
