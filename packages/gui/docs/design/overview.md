...
> Chrome presentation: [Feature](../features/chrome-presentation.md) ·
> [Design](chrome-presentation.md)
> Chrome tool-window layout: [Design](chrome-tool-window-layout.md)
...
> [GUI Code Organization Design](code-organization.md).
...
[Tool-Window Row Layout](chrome-tool-window-layout.md).
...
[GUI Chrome Presentation](../features/chrome-presentation.md) and designed in
[GUI Chrome Presentation Design](chrome-presentation.md).
...
[GPUI Dependency Pins](../dependency-pins.md).
...
validation docs live under this directory:

- [`launch.md`](../launch.md)
- [`known-limitations.md`](../known-limitations.md)
- [`dependency-pins.md`](../dependency-pins.md)
