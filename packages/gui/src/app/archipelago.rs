...
//!
//! Navigation: [`island::runtime::archipelago::ArchipelagoRouter`] via
...
use island::runtime::archipelago::{ArchipelagoRouter, ArchipelagoWorkspace};
use island::runtime::layout::{IslandAxis, IslandNode};
...
mod tests {
    use super::*;
    use island::runtime::layout::IslandNode;
    ...
    fn route_archipelago_nav_toggle_pair() {
        use island::runtime::archipelago::{ArchipelagoNav, route_archipelago_nav};
