...
//!
//! Not a layout unit. Agents and Tree remain separate islands; shell only
//! stacks injected children when both are visible.
...
/// Mount Agents / Tree island elements in the dock or sheet split.
