...
fn workspace_tools() -> Vec<ToolDef> {
    use crate::protocol::tools::{ToolApprovalRequirement, ToolCapability, ToolExecutorRef};
    ...
    vec![
        ToolDef {
            ...
            execution_mode: None,
            exposure: None,
            capabilities: Some(vec![ToolCapability::ReadWorkspace]),
        ...
        ToolDef {
            ...
            execution_mode: None,
            exposure: None,
            capabilities: Some(vec![ToolCapability::WriteWorkspace]),
            approval: Some(ToolApprovalRequirement::OnRequest),
            metadata: None,
        },
        ToolDef {
