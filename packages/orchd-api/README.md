...
See the [codex-rs Agent Core Digest](../../docs/codex-agent-core-digest.md)
and [Agent Runtime Roadmap](../../docs/agent-runtime-roadmap.md) for the
runtime model and feature sequencing.
