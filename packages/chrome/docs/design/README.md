...
**How** this chrome kit is structured and wired.

| Doc | Topic |
|---|---|
| [overview.md](overview.md) | Layers L1–L4, non-goals, decision rules |
| [archipelago.md](archipelago.md) | Router, workspace, route order |
| [archipelago-runtime.md](archipelago-runtime.md) | Closing the workspace + route path |
...
Status and planning: [`../roadmap/`](../roadmap/).
